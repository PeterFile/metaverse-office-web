...
- Hermes runtime file ingestion is opt-in via `METAVERSE_OFFICE_HERMES_RUNTIME_SOURCES_FILE`; unset keeps existing empty behavior, set reads local JSON arrays or JSONL facts only, and invalid input fails collection before append
