...
- shared memory artifact index that derives an engineering memory surface and replay checkpoints from existing evidence refs and collector observations without introducing markdown-backed status storage or a task-assignment layer
