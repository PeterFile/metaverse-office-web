...
- the selected-agent Evidence Ledger starts with a compact Proof Compass/basis summary derived only from already loaded evidence records; it redacts local path-like evidence refs in the summary, suppresses local path basenames in inspected source anchors, preserves the detailed ledger behind explicit inspection, and does not add write/control-plane requests
