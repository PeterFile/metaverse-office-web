...
async function handleRequest({
  ...
  if (method === 'GET' && pathname === '/collectors/controller-snapshot/schema') {
    sendJson(res, 200, {
      item: store.getControllerSnapshotSchema()
    });
    return;
  }
  ...
  if (method === 'GET' && pathname === '/evidence-records/schema') {
    sendJson(res, 200, {
      item: store.getEvidenceRecordsSchema()
    });
    return;
  }
