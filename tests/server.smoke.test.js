...
const SAFE_ROUTE_HOSTILE_CANARIES = [
  ...
  '../safe-route-canary/runtime.json',
  ...
  'task://safe-route-canary/raw-ref',
  'profile://safe-route-canary',
  'session://safe-route-canary',
  'token=safe-route-canary',
  'github_pat_safe-route-canary',
  'xoxb-safe-route-canary',
  'webhook-safe-route-canary',
  'payload=safe-route-canary',
  'metadata=safe-route-canary',
